...
const AdminSignup = () => {
    ...
    const [ signupData, setSignupData ] = useState({ firstName: '', lastName:'', email: 'vishalbhong9803@gmail.com', mobileNo: '', address: '', storeName:'', password: '',confirmPassword: '' });
    ...
    const handleClear = () => {
        setSignupData({ firstName: '', lastName:'', email: '', mobileNo: '', address: '', storeName:'', password: '', confirmPassword: '' });
    ...
    return (
        <>
            <form className="flex-column border border-dark" id="register" >            
                ...
                <div className="col-12 mt-3 ms-2" id="fullwidthinput">
                <input type="text" className="form-control form-control-lg" placeholder="Store Name" aria-label="store name" value={signupData.storeName} onChange={(e) => setSignupData({ ...signupData, storeName: e.target.value })} />               
                </div>             
