...
const AdminLogin = () => {
    ...
    const handleGetOtp = (e) => {
      ...
      axios.post('http://localhost:5000/admin/generateOtpForEmail', forgotPassData)
       .then(res =>{ 
    ...
    const handleOtpSubmit = (e) => {
      ...
      axios.post('http://localhost:5000/admin/verifyOtpForEmail', forgotPassData)
       .then(res =>{
    ...
    const handlePasswordChange = (e) => {
      ...
      axios.post('http://localhost:5000/admin/forgotPassword', forgotPassData)
       .then(res =>{
          toast.success(`${res.data.message}`)                  
       })
       .catch((err) => {
              ...
              (<>
                  <form className="border border-dark" autoComplete="off" onSubmit={handleSubmit} id="login">        
                    <div className="d-flex flex-column align-items-center" >
                      <h2 className="fw-bold mt-2" id="logintitle">Admin Log In</h2> 
                      ...
                      <div className="col-12 d-flex justify-content-end mb-2 me-4">
                        <a className="fw-bold" href="/admin/signup">Don't have an account.Click here to Sign in</a>
                      </div>
                      <div className="col-12 d-flex justify-content-end mb-2">
                        <a className="me-3 fw-bold" href="/user/login">User Login ?</a>
                      </div>
                    </div>
                  </form>
              </>) :
              ...
              (<>
                <form className="border border-dark" autoComplete="off" onSubmit={handlePasswordChange} id="login">        
                  <div className="d-flex flex-column align-items-center" >
                    ...
                    <div className="col-12 d-flex justify-content-end mb-2 me-4">
                        <a className="mt-2 me-1 fw-bold text-decoration-none" href="/admin/login">Go back to Login Page ?</a>
                    </div>
                    <div className="col-12 mt-2" id="loginitem">
                      <button className="btn btn-primary mb-4" id="loginbtn" type="submit">Submit</button>
                    </div> 
